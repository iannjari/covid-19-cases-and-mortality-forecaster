...
def regions_group():
    ...
    regions=regions.rename(columns={"Country": "Country/Region"})
    region_df = pd.merge(death_map,regions, how="left", on="Country/Region")
    grouped=pd.DataFrame(region_df.groupby('Region').sum())
